...
#define Forwards 1
#define Backwards -1
#define r_motor_factor 88
#define l_motor_factor 100
//************servos*********
#define slow  50
#define medium  10
#define fast  5
...
void Drive(int speed){
    motor(LeftMotor, (l_motor_factor*speed/100));
    motor(RightMotor, (r_motor_factor*speed/100));
...
void clawOpen(){
    move_servo(arm, claw_open, medium);
}
